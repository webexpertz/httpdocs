 ...
 *
 */
class GetMembershipAccreditationItemByIdRequest extends AbstractRequest implements GuidRequestInterface, PagedRequestInterface, RecordCountRequestInterface {

  public function getRequiredParams() {
    return array('guid', 'accreditationItemID', 'page', 'recordcount');
  }
  ...
  /**
   * Set the accreditationItemID to retrieve records for.
   *
   * @param string $accreditationItemID
   *   The accreditationItemID to set to.
   *
   * @return $this
   */
