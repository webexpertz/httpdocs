 ...
 *
 */
class GetAwardsWinnersRequest extends AbstractRequest implements GuidRequestInterface, PagedRequestInterface, RecordCountRequestInterface {

  public function getRequiredParams() {
    return array('guid', 'awardId', 'page', 'recordcount');
  }
   ...
   *
   * @param int $awardId
   *   The award id to set to.
   *
   * @return $this
   */
  public function setAwardId($awardId) {
    $this->setParam('awardId', $awardId);
    return $this;
  }
