 ...
 *
 */
class GetContactDonationsRequest extends AbstractRequest implements GuidRequestInterface, PagedRequestInterface, RecordCountRequestInterface {

  public function getRequiredParams() {
    return array('guid', 'page', 'recordcount', 'contactId');
  }
