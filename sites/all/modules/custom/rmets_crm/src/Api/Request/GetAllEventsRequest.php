 ...
 *
 */
class GetAllEventsRequest extends AbstractRequest implements GuidRequestInterface, PagedRequestInterface, RecordCountRequestInterface {
  ...
  /**
   * Set the from date to be returned.
   *
   * @param int $fromDate
   *   The record count to set to.
   *
  ...
  public function setFromDate($fromDate) {
    $this->setParam('fromDate', $fromDate);
    return $this;
  }
}
